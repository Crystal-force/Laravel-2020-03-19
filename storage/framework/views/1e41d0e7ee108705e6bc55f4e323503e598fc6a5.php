...
<?php $__env->startSection('content'); ?>
					<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
									...
									<div class="kt-header-menu-wrapper" id="kt_header_menu_wrapper">
										<div class="filtermenu">
												...
												<select class="form-control kt-select2" id="smetro_name" style="width:120px;"  name="smetro_name" >
														<option></option>
														<?php $__currentLoopData = $metros; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
															<option value="<?php echo e($row->metro_name); ?>" ><?php echo e($row->metro_name); ?></option>
						...
						<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
								...
								<?php echo $__env->make('dashboard.table', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
								<?php echo $__env->make('dashboard.modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
						</div>
...
<!--					<script src="<?php echo e(asset('js/admin/dashboard.js')); ?>" type="text/javascript"></script>-->
					<script src="<?php echo e(asset('js/dashboard/campaign.js')); ?>" type="text/javascript"></script>
					
					

<?php $__env->stopSection(); ?>

<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\adsbackend\resources\views/home.blade.php ENDPATH**/ ?>
...
<link href="{{asset('assets/base/style.bundle-lg.css')}}" rel="stylesheet" type="text/css" />
<style>
                                                ...
                                                <div class="kt-widget kt-widget--user-profile-4" style="background-color:#ffb822b8;padding:20px;">
                                                    <div class="kt-widget__head">
                                                        <div class="kt-widget__media">
                                                            <img class="kt-widget__img kt-hidden-" src="{{asset('img/upload/300_21.jpg')}}" alt="image">
                                                        </div>
...
<script>  routing_campaign_id={{$campaign_id}};</script>
@endif
@if (isset($user_id))
<script>  routing_user_id={{$user_id}};</script>
@endif
@if (isset($account_id))
<script>  routing_account_id={{$account_id}};</script>
@endif
@if (isset($flag))
<script>  flag={{$flag}};</script>
@endif
@if (isset($start))
<script> 
routing_start='{{$start}}';
...
<script src="{{asset('js/admin/ads.js')}}" type="text/javascript"></script>
@endsection

                ...
                <div class="col-lg-3">
                        ...
                        <select class="form-control kt-select2" id="account_id" name="account_id">
                                ...
                                @foreach ($accounts as $row)
                                    <option value="{{ $row->account_id}}" >{{ $row->email_id}}</option>
                                @endforeach
						</select>
                </div>
                ...
                <div class="col-lg-4">
                     <label>Sub category:</label>
                        ...
                        <select class="form-control kt-select2"  id="sub_category_name" name="sub_category_name">
                                <option></option>
                                @foreach ($cats as $row)
                                    <option value="{{ $row->sub_category_name}}" >{{ $row->sub_category_name}}</option>
                                @endforeach
						</select>
                </div>
                ...
                <div class="col-lg-3">
                    <label>Spec location:</label>
                        <select class="form-control kt-select2" id="spec_location" name="spec_location">
                                <option></option>
                                @foreach ($speclocations as $row)
                                    <option value="{{ $row->spec_location}}" >{{ $row->spec_location}}</option>
                                @endforeach
                        </select>
                </div>
                <div class="col-lg-3">
                ...
                <div class="col-lg-2">
                    <label>Zip code:</label>
                        <select class="form-control kt-select2"  id="zip_code" name="zip_code">
                                <option></option>
                                @foreach ($locations as $row)
                                    <option value="{{ $row->zip_code}}" >{{ $row->zip_code}}</option>
                                @endforeach
                        </select>
                </div>
                 <div class="col-lg-3">
                    ...
                    <label>housing type:</label>
                        <select class="form-control kt-select2" id="housing_type" name="housing_type">
                                ...
                                @foreach ($houses as $row)
                                    <option value="{{ $row->housing_name}}" >{{ $row->housing_name}}</option>
                                @endforeach
                        </select>
                </div>
                <div class="col-lg-2">
                    <label>laundryType:</label>
                        <select class="form-control kt-select2" id="laundry_type" name="laundry_type">
                                <option></option>
                                @foreach ($laundry_type as $row)
                                    <option value="{{ $row->laundry_name}}" >{{ $row->laundry_name}}</option>
                                @endforeach
                    </select>
                </div>
                <div class="col-lg-2">
                    <label>parkingType:</label>
                        <select class="form-control kt-select2" id="parking_type" name="parking_type">
                                ...
                                @foreach ($parking_type as $row)
                                    <option value="{{ $row->parking_name}}" >{{ $row->parking_name}}</option>
                                @endforeach
                    </select>
                </div>
                <div class="col-lg-2">
                    <label>bathroomType:</label>
                        <select class="form-control kt-select2" id="bathrooms_type" name="bathrooms_type">
                                <option></option>
                                @foreach ($bathroom_type as $row)
                                    <option value="{{ $row->bathroom_name}}" >{{ $row->bathroom_name}}</option>
                                @endforeach
                    </select>
                </div>
                ...
                <div class="col-lg-2">
                    <label>bedroomType:</label>
                        <select class="form-control kt-select2" id="bedrooms_type" name="bedrooms_type">
                                <option></option>
                                @foreach ($bedroom_type as $row)
                                    <option value="{{ $row->bedroom_name}}" >{{ $row->bedroom_name}}</option>
                                @endforeach
                    </select>
                </div>
                <div class="col-lg-2">
                ...
                <div class="col-lg-2">
                    <label>Sell condition:</label>
                        <select class="form-control kt-select2" id="sell_condition" name="sell_condition">
                                <option></option>
                                @foreach ($sell_condition as $row)
                                    <option value="{{ $row->sell_condition_name}}" >{{ $row->sell_condition_name}}</option>
                                @endforeach
                    </select>
                </div>
                <div class="col-lg-2">
